    ...
    <div class="section-container d-block d-lg-flex gap-5 shop mt-5 pt-5">
      ...
      <div class="shop__products col-12">
          ...
          foreach ($data as $d):
            ...
            <div class="products__item col-6 col-md-4 col-lg-3 mb-5">
              <div class="product__header mb-3">
                <a href="single-product.php?id=<?= $d->getProductId() ?>">
                  <div class="product__img-cont">
                    <img class="product__img w-100 h-100 object-fit-cover" src="assets/images/<?= $d->getImage() ?>"
                      data-id="white" />
                  </div>
                </a>
                <?php if ($d->getOfferValue() > 0): ?>
              ...
              <div class="product__title text-center">
                <a class="text-black text-decoration-none" href="single-product.php?id=<?= $d->getProductId() ?>">
                  <?= $d->getProductName() ?>
                </a>
              </div>
        ...
        <div class="products__pagination mb-5 d-flex justify-content-center gap-2">
          ...
          <?php
          $i = 1;
          while (BookController::setCount($db) >= $i):
            ?>
            <a href="?page=<?= $i ?>">
              <span class="pagination__btn rounded-1 <?= BookController::isActive($i , $start)?>"><?= $i++ ?></span>
            </a>
          <?php endwhile; ?>
          <a href="?page=<?= $start+1 ?>">
